...
for x, electric_furnace in pairs(electric_furnaces) do
    ...
    entity.animation.layers[1].filename = "__darkstar-machines__/graphics/entity/" .. electric_furnace.name .. "/electric-furnace-base.png"
    entity.animation.layers[1].hr_version.filename = "__darkstar-machines__/graphics/entity/" .. electric_furnace.name .. "/hr-electric-furnace.png"
